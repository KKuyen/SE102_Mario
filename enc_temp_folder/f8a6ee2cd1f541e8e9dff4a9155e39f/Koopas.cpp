...
void CKoopas::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
	...
	if (state == KOOPAS_STATE_WALKING || state == KOOPAS_STATE_WALKING_RIGHT)
	{
		...
		for (LPGAMEOBJECT obj : *coObjects)
		{
			...
			if ( dynamic_cast<CGrassPlatform*>(obj) || dynamic_cast<CPlatform*>(obj) ||( dynamic_cast<CBreakableBrick*>(obj) )|| (dynamic_cast<CColorBox*>(obj) && dynamic_cast<CColorBox*>(obj)->isPlatform == 1) || dynamic_cast<CBrick*>(obj))
			{
